...
@DesignerComponent(version = 1,
        category = ComponentCategory.EXTENSION,
		   description = "Extension for teaching a machine to recognize different images.",
        nonVisible = true)
...
public final class TeachableMachine extends AndroidNonvisibleComponent implements Component {
  ...
  private static final int ERROR_WEBVIEWER_REQUIRED = -8;

  private WebView webview;
  private final Form form;

  public TeachableMachine(Form container) {
    super(container);
    this.form = container.$form();
    requestHardwareAcceleration(container);
  ...
  private void configureWebView(WebView webview) {
	  ...
	  try {
	    webview.loadUrl(form.getAssetPathForExtension(this, "teachablemachine.html"));
  ...
  public void Initialize() {
	  ...
	  if (webview == null) {
		  form.dispatchErrorOccurredEvent(this, "WebViewer", ErrorMessages.ERROR_EXTENSION_ERROR, ERROR_WEBVIEWER_REQUIRED, LOG_TAG, "You must specify a WebViewer component in the WebViewer property.");
	  }
  }
